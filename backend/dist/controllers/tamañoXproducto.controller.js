...
exports.obtenerTamañosXProductos = exports.filtrarTamañoXProductoPorSubcategoria = exports.crearTamañoXProducto = void 0;
var _tamañoXproducto = require("../models/tama\xF1oXproducto.model");
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // Modelo de la categoría
// Crear TamañoXProducto
var crearTamañoXProducto = exports.crearTamañoXProducto = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, idProducto, idTamaño, nuevoTamañoXProducto;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, idProducto = _req$body.idProducto, idTamaño = _req$body.idTamaño; // Verifica los nombres de los campos
          _context.prev = 1;
          ...
          return _context.abrupt("return", res.status(400).json({
            error: "idProducto y idTamaño son obligatorios"
          }));
        case 4:
          _context.next = 6;
          return _tamañoXproducto.TamañoXProducto.create({
            idProducto: idProducto,
            idTamaño: idTamaño
          });
        case 6:
          nuevoTamañoXProducto = _context.sent;
          res.status(201).json({
        ...
        case 10:
          ...
          console.error("Error al crear TamañoXProducto:", _context.t0.message, _context.t0.stack);
          res.status(500).json({
            error: "Error interno del servidor",
            detalles: _context.t0.message
          });
        case 14:
        case "end":
  ...
  return function crearTamañoXProducto(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

// Obtener todas las relaciones TamañoXProducto
var obtenerTamañosXProductos = exports.obtenerTamañosXProductos = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var tamañosXProductos;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _tamañoXproducto.TamañoXProducto.findAll({
            include: [{
        ...
        case 3:
          tamañosXProductos = _context2.sent;
        ...
        case 7:
          ...
          console.error("Error al obtener TamañosXProductos:", _context2.t0);
          res.status(500).json({
            error: "Error interno del servidor"
          });
        case 11:
  ...
  return function obtenerTamañosXProductos(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

// Filtrar TamañosXProductos por subcategoría
var filtrarTamañoXProductoPorSubcategoria = exports.filtrarTamañoXProductoPorSubcategoria = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var idSubcategoria, tamañosXProductos;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          tamañosXProductos = _context3.sent;
          if (tamañosXProductos.length > 0) {
            res.status(200).json(tamañosXProductos);
          } else {
            res.status(404).json({
              error: "No se encontraron productos con los tamaños en esta subcategoría"
            });
          }
          _context3.next = 12;
          break;
        case 8:
          ...
          console.error("Error al filtrar TamañoXProducto por subcategoría:", _context3.t0);
          res.status(500).json({
            error: "Error interno del servidor"
          });
        case 12:
  ...
  return function filtrarTamañoXProductoPorSubcategoria(_x5, _x6) {
