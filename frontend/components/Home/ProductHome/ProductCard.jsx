...
const ProductCard = ({ producto }) => {
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        return false; // Retorna false si hubo un error en la respuesta del servidor
      }
    } catch (error) {
      ...
      return false; // Retorna false si ocurrió un error en la solicitud
    } finally {
  ...
  const onConfirm = (tamaño, personalizacion) => {
  ...
  return (
    <div className="bg-white text-black shadow-lg rounded-lg border border-pink-200 p-4 flex flex-col max-w-xs mx-auto">
        ...
        <div className="flex justify-between mb-4 gap-8">
          ...
          <div className="flex items-center">
            <div className="relative flex items-center">
              ...
              >
                <svg
                  className="w-2.5 h-2.5 text-principal"
                  aria-hidden="true"
      ...
      <div className="flex justify-center">
        <Button
          onClick={ventanaDetalle}
          className="bg-btnSideBar2 text-black rounded-md px-4 py-2 hover:bg-principal flex items-center mr-4"
        >
        ...
        <Button
          onClick={onOpen}
          className="bg-btnSideBar2 text-black rounded-md px-4 py-2 hover:bg-principal flex items-center"
        >
          <span className="text-lg text-black cursor-pointer active:opacity-50 mr-2">
